 ...
 * <p>实验一概述：
 * <ol>
 *     <li>{@link Student} 学习了惰性求值的思想并应用于平均分字段，减少使用除法操作的次数。</li>
 *     <li>泛型工具类 {@link ArraySortAndSearchWrapper} 包裹了实验要求的两个方法，学习了 {@code Comparator} 接口。</li>
 *     <li>工具类 {@link PrimeNumber} 使用线程池及其相关类完成并行计算任务。</li>
 *     <li>工具类 {@link PerfectNumber} 使用Fork/Join框架提供的类完成计算密集型任务。</li>
 *     <li>工具类 {@link FeasibleSoluSet} 使用静态内部类 {@link FeasibleSoluSet.Tuple} 与 {@code List<T} 完成API设计工作。</li>
 * </ol></p>
 * @author 段云飞
 * @since 2019-10-18
 */
